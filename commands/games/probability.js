...
module.exports = {
    ...
    run: async(client, message, args) => {
        if (!args[0]) {
            return message.reply("Не можете придумать, что проверять? А зачем тогда играть? xD")
            ...
            const embed = new RichEmbed()
                ...
                .setTimestamp()
                .setDescription(stripIndents `**> Запрашивающий игрок:** ${message.author.username} (${message.author.id})
            ...
            **> Вероятность:** ${randomInteger(0, 100)} %`);
            ...
            const promptEmbed = new RichEmbed()
                ...
                .setDescription(`Вы действительно хотите узнать о(-б): ${args.slice(0).join(" ")}?`);
            ...
            message.channel.send(promptEmbed).then(async msg => {
                ...
                if (emoji === "✅") {
                    ...
                    message.reply(`Процедура игры "Вероятности" прекращена!`)
                        .then(m => m.delete(5000));
                }
            });
        }
